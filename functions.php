...
function add_my_files() {
  wp_enqueue_style( 'Noto_Sans_JP', 'https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100;300;400;500;700;900&display=swap' );
  wp_enqueue_script( 'Uikit', get_theme_file_uri('/uikit/js/uikit.js') );
}
